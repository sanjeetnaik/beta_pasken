...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future _incrementCounter() async {
    setState((){
      _counter++;
      //TODO:: small operations for inserting the data
      this.storageData['"$_counter"'] = {'"question"':'"question${_counter.toString()}"'};
  ...
  //TODO::file handling starts here
  ...
  Future openFile(String username)async{
      try{
        ...
        this.file = new File('$dir/$username.psk');
  ...
  @override
  Widget build(BuildContext context) {
    //TODO:: check for the function call that will read the file when the build is called
    var data = readFile();
    print(data);
